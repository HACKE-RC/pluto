...
class Drawer(Gtk.Window):
    ...
    def _build_panel(self) -> None:
        ...
        sep = Gtk.Separator(orientation=Gtk.Orientation.VERTICAL, valign=Gtk.Align.CENTER)
        sep.add_css_class("footer-sep")
        self.footer.append(sep)
        delete_all = Gtk.Button(label="delete all", valign=Gtk.Align.CENTER, has_frame=False, tooltip_text="Remove everything from this shelf")
        delete_all.add_css_class("footer-action")
        delete_all.connect("clicked", lambda *_: self.store.clear())
        self.footer.append(delete_all)
